fn part1(input: &str) {
    ...
    for (row, line) in lines.iter().enumerate() {
        ...
        for (col, c) in line.chars().enumerate() {
            if id_start.is_none() && c.is_ascii_digit() {
                id_start = Some(col);
            } else if id_start.is_some() && !c.is_ascii_digit() {
                if touching {
                    let num: u32 = line[id_start.unwrap()..col].parse().unwrap();
                    println!("{}", num);
                    sum += num;
                }
                id_start = None;
            ...
            if id_start.is_none() || touching {
                continue;
            }

            if col > 0 {
                let sc = line.chars().nth(col - 1).unwrap();
                let t = !(sc.is_ascii_digit() || sc == '.');
                touching |= t;
            }
            if col + 1 < columns {
                let sc = line.chars().nth(col + 1).unwrap();
            ...
            if row > 0 {
                let sc = lines[row - 1].chars().nth(col).unwrap();
                let t = !(sc.is_ascii_digit() || sc == '.');
                touching |= t;
            }
            if row + 1 < rows {
            ...
            if col > 0 && row > 0 {
                let sc = lines[row - 1].chars().nth(col - 1).unwrap();
                touching |= !(sc.is_ascii_digit() || sc == '.');
            }
...
......696..................................................753......................957.715.............396..159...........338.......806....";
    ...
    println!("This does not currently work!");
}
